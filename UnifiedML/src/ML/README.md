...
You can include a ```train=``` boolean arg to your custom Dataset to define it for training and testing, or use a different custom test Dataset via ```TestDataset=``` and the same syntax.
