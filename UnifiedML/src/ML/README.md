...
You can include a ```train=``` boolean arg to your custom Dataset to have it toggled between train and test modes, or use a different custom test Dataset via ```TestDataset=``` and the same syntax.
