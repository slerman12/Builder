...
Since the default task is ```task=classify```, the above script will launch classification on ```MyDataset```.
...
By [Sam Lerman](https://www.github.com/slerman12), with support from doctoral advisor [Professor Chenliang Xu](https://www.cs.rochester.edu/~cxu22/) and [XRD project team](https://www.github.com/AGI-init/XRDs).
