...
3. Note: we often use the "task" and "recipe" terms interchangeably. Both refer to the ```task=``` flag. [Method 6 below](#method-6-recipes) shows how to define a task/recipe.
