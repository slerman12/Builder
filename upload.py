...
# 1. Remove previous token there: (a) scrolls to API tokens, (b) Options -> "Remove token"
...
# Note: A push to GitHub can be undone in Intellij Idea via the bottom "Git" tab -> right click the desired commit
