...
# List of lists of experiments to plot together  & get logs for
my_plots.plots = [['example']]

# List of experiments to get checkpoints for
my_checkpoints.experiments = ['example']
```
